...
>(({ className, children }, ref) => {
	return (
		<CommandList
			ref={ref}
			className={cn(
				'bg-white p-2 flex flex-col gap-2 rounded-md scrollbar-thin scrollbar-track-transparent transition-colors scrollbar-thumb-muted-foreground dark:scrollbar-thumb-muted scrollbar-thumb-rounded-lg w-full absolute shadow-md z-10 border border-muted top-0',
				className
			)}
		>
			{children}
