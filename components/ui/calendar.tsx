  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-neutral-900 text-white hover:bg-neutral-900 hover:text-white/80 focus:bg-neutral-900 focus:text-neutral-50 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-neutral-900",
